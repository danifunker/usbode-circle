...
SH1106USBConfigPage::SH1106USBConfigPage(CSH1106Display* display, C2DGraphics* graphics)
    : m_Display(display),
      m_Graphics(graphics) {
    config = static_cast<ConfigService*>(CScheduler::Get()->GetTask("configservice"));
}

SH1106USBConfigPage::~SH1106USBConfigPage() {
...
void SH1106USBConfigPage::OnExit() {
    m_ShouldChangePage = false;
}

bool SH1106USBConfigPage::shouldChangePage() {
    return m_ShouldChangePage;
}

const char* SH1106USBConfigPage::nextPageName() {
    return "configpage";
}

void SH1106USBConfigPage::OnButtonPress(Button button) {
...
void SH1106USBConfigPage::MoveSelection(int delta) {
...
void SH1106USBConfigPage::Refresh() {
    // TODO We shouldn't redraw everything!
    // Draw();
}

void SH1106USBConfigPage::SaveAndReboot() {
...
void SH1106USBConfigPage::DrawConfirmation(const char* message) {

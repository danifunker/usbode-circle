#ifndef _SH1106_USBCONFIGPAGE_H
#define _SH1106_USBCONFIGPAGE_H
...
class SH1106USBConfigPage : public IPage {
   public:
    SH1106USBConfigPage(CSH1106Display* display, C2DGraphics* graphics);
    ~SH1106USBConfigPage();

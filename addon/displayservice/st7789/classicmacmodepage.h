#ifndef _ST7789_CLASSICMACMODEPAGE_H
#define _ST7789_CLASSICMACMODEPAGE_H
...
class ST7789ClassicMacModePage : public IPage {
   public:
    ST7789ClassicMacModePage(CST7789Display* display, C2DGraphics* graphics);
    ~ST7789ClassicMacModePage();

...
ST7789ConfigPage::ST7789ConfigPage(CST7789Display* display, C2DGraphics* graphics)
: m_Display(display),
  m_Graphics(graphics)
{
}

ST7789ConfigPage::~ST7789ConfigPage() {
    LOGNOTE("ConfigPage starting");
}

void ST7789ConfigPage::OnEnter()
{
...
void ST7789ConfigPage::OnExit()
{
	m_ShouldChangePage = false;
}

bool ST7789ConfigPage::shouldChangePage() {
	return m_ShouldChangePage;
}

const char* ST7789ConfigPage::nextPageName() {
	return m_NextPageName;
}

void ST7789ConfigPage::OnButtonPress(Button button)
{
...
void ST7789ConfigPage::MoveSelection(int delta) {
...
void ST7789ConfigPage::DrawNavigationBar(const char* screenType)
{

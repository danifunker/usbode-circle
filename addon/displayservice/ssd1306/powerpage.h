#ifndef _SSD1306_POWERPAGE_H
#define _SSD1306_POWERPAGE_H
...
class SSD1306PowerPage : public IPage {
   public:
    SSD1306PowerPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics);
    ~SSD1306PowerPage();

#ifndef _SSD1306_IMAGESPAGE_H
#define _SSD1306_IMAGESPAGE_H
...
class SSD1306ImagesPage : public IPage {
   public:
    SSD1306ImagesPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics);
    ~SSD1306ImagesPage();

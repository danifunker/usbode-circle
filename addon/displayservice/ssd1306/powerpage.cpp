...
SSD1306PowerPage::SSD1306PowerPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics)
    : m_Display(display),
      m_Graphics(graphics) {
}

SSD1306PowerPage::~SSD1306PowerPage() {
    LOGNOTE("PowerPage starting");
}

void SSD1306PowerPage::OnEnter() {
    LOGNOTE("Drawing PowerPage");
    Draw();
}

void SSD1306PowerPage::OnExit() {
    m_ShouldChangePage = false;
}

bool SSD1306PowerPage::shouldChangePage() {
    return m_ShouldChangePage;
}

const char* SSD1306PowerPage::nextPageName() {
    return "configpage";
}

void SSD1306PowerPage::OnButtonPress(Button button) {
...
void SSD1306PowerPage::MoveSelection(int delta) {
...
void SSD1306PowerPage::Refresh() {
    // TODO We shouldn't redraw everything!
    // Draw();
}

void SSD1306PowerPage::DrawConfirmation(const char* message) {

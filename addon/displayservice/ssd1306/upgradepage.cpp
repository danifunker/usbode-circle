...
SSD1306UpgradePage::SSD1306UpgradePage(CSSD1306GfxDisplay* display, C2DGraphics* graphics)
    : m_ShouldChangePage(false), m_Display(display), m_Graphics(graphics), m_refreshCounter(0) {
    m_statusText[0] = '\0';
}

SSD1306UpgradePage::~SSD1306UpgradePage() {
    LOGNOTE("UpgradePage destroyed");
}

void SSD1306UpgradePage::OnEnter() {
...
void SSD1306UpgradePage::OnExit() {
    m_ShouldChangePage = false;
}

bool SSD1306UpgradePage::shouldChangePage() {
    return m_ShouldChangePage;
}

const char* SSD1306UpgradePage::nextPageName() {
    return "homepage";
}

void SSD1306UpgradePage::OnButtonPress(Button buttonId) {
...
void SSD1306UpgradePage::Refresh() {
    m_refreshCounter++;

...
SSD1306ConfigPage::SSD1306ConfigPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics)
: m_Display(display),
  m_Graphics(graphics)
{
}

SSD1306ConfigPage::~SSD1306ConfigPage() {
    LOGNOTE("ConfigPage starting");
}

void SSD1306ConfigPage::OnEnter()
{
...
void SSD1306ConfigPage::OnExit()
{
	m_ShouldChangePage = false;
}

bool SSD1306ConfigPage::shouldChangePage() {
	return m_ShouldChangePage;
}

const char* SSD1306ConfigPage::nextPageName() {
	return m_NextPageName;
}

void SSD1306ConfigPage::OnButtonPress(Button button)
{
...
void SSD1306ConfigPage::MoveSelection(int delta) {
...
void SSD1306ConfigPage::Refresh()
{
}

void SSD1306ConfigPage::Draw()
{
    size_t fileCount = sizeof(options) / sizeof(options[0]);
    if (fileCount == 0) return;

#ifndef _SSD1306_SOUNDCONFIG_H
#define _SSD1306_SOUNDCONFIG_H
...
class SSD1306SoundConfigPage : public IPage {
   public:
    SSD1306SoundConfigPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics);
    ~SSD1306SoundConfigPage();

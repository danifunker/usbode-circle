...
SSD1306TimeoutConfigPage::SSD1306TimeoutConfigPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics)
: m_Display(display),
  m_Graphics(graphics)
{
...
SSD1306TimeoutConfigPage::~SSD1306TimeoutConfigPage() {
    LOGNOTE("TimeoutConfigPage starting");
}

void SSD1306TimeoutConfigPage::OnEnter()
{
...
size_t SSD1306TimeoutConfigPage::FindClosestTimeout(unsigned currentTimeout)
{
...
void SSD1306TimeoutConfigPage::OnExit()
{
	m_ShouldChangePage = false;
}

bool SSD1306TimeoutConfigPage::shouldChangePage() {
	return m_ShouldChangePage;
}

const char* SSD1306TimeoutConfigPage::nextPageName() {
	return m_NextPageName;
}

void SSD1306TimeoutConfigPage::OnButtonPress(Button button)
{
...
void SSD1306TimeoutConfigPage::MoveSelection(int delta) {
...
void SSD1306TimeoutConfigPage::Refresh()
{
}

void SSD1306TimeoutConfigPage::Draw()
{

#ifndef _SSD1306_USBCONFIGPAGE_H
#define _SSD1306_USBCONFIGPAGE_H
...
class SSD1306USBConfigPage : public IPage {
   public:
    SSD1306USBConfigPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics);
    ~SSD1306USBConfigPage();

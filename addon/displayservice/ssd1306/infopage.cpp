...
SSD1306InfoPage::SSD1306InfoPage(CSSD1306GfxDisplay* display, C2DGraphics* graphics)
    : m_Display(display),
      m_Graphics(graphics) {
}

SSD1306InfoPage::~SSD1306InfoPage() {
    LOGNOTE("InfoPage starting");
}

void SSD1306InfoPage::OnEnter() {
    LOGNOTE("Drawing InfoPage");
    Draw();
}

void SSD1306InfoPage::OnExit() {
    m_ShouldChangePage = false;
}

bool SSD1306InfoPage::shouldChangePage() {
    return m_ShouldChangePage;
}

const char* SSD1306InfoPage::nextPageName() {
    return "configpage";
}

void SSD1306InfoPage::OnButtonPress(Button button) {
...
void SSD1306InfoPage::MoveSelection(int delta) {
}

void SSD1306InfoPage::Refresh() {
}

void SSD1306InfoPage::Draw() {

...
"                        <button type=\"submit\" name=\"action\" value=\"soundtest\" class=\"button\">Execute Sound Test</button>\n"
"                    </div>\n"
"                    {{/sound_test_available}}\n"
"\n"
"                    {{^sound_test_available}}\n"
"                    <div class=\"form-group\">\n"
"                        <label>Audio Test:</label>\n"
"                        <div class=\"current-value\">Sound test not available (not in CDROM mode or sound not enabled)</div>\n"
"                    </div>\n"
"                    {{/sound_test_available}}\n"
"                </div>\n"
"\n"

...
const char* ConfigService::GetUSBProtocol(const char* defaultValue)
{
    return m_config->GetString("usb_protocol", defaultValue);
}

void ConfigService::SetUSBProtocol(const char* value)
{
    m_config->SetString("usb_protocol", value);
}

...
void FillModePage2A(ModePage0x2AData &codepage)
{
    ...
    codepage.capabilityBits[1] = 0x01; // All writable types
    codepage.capabilityBits[2] = 0xB1; // AudioPlay, composite audio/video, digital port 2, Mode 2 Form 2, Mode 2 Form 1
...
void CUSBCDGadget::HandleSCSICommand()
{
    ...
    case 0x25: // Read Capacity (10)
    {
        ...
        CDROM_DEBUG_LOG("CUSBCDGadget::HandleSCSICommand", 
                        "READ CAPACITY: lastBlock=%lu (0x%08x), sectorSize=%lu", 
                        lastBlock, lastBlock, sectorSize);
